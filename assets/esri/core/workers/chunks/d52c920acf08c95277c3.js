"use strict";(self.webpackChunkRemoteClient=self.webpackChunkRemoteClient||[]).push([[723],{32078:(e,t,r)=>{r.d(t,{D:()=>W,b:()=>G});var i=r(13598),o=r(1391),n=r(62707),a=r(55039),s=r(51546),l=r(77171),c=r(47624),d=r(60624),u=r(37099),h=r(76056),m=r(135),f=r(11317),p=r(15719),g=r(92555),v=r(89136),_=r(15817),T=r(95134),x=r(89753),b=r(5802),A=r(42001),E=r(19419),S=r(26322),w=r(85504),R=r(22539),C=r(57806),y=r(92302),O=r(96310),M=r(85787),P=r(90692),I=r(62062),N=r(172),L=r(71250),D=r(21437),H=r(74709),F=r(8319),B=r(33680),U=r(98069),z=r(93144),V=r(35065);function G(e){const t=new B.kG,{vertex:r,fragment:G,varyings:W}=t;if((0,I.Sv)(r,e),t.include(u.f),W.add("vpos","vec3"),t.include(y.k,e),t.include(c.f,e),t.include(g.L,e),e.hasColorTextureTransform&&t.include(C.av),e.output===a.H.Color||e.output===a.H.Alpha){e.hasNormalTextureTransform&&t.include(C.NI),e.hasEmissionTextureTransform&&t.include(C.R5),e.hasOcclusionTextureTransform&&t.include(C.jF),e.hasMetallicRoughnessTextureTransform&&t.include(C.DT),(0,I.hY)(r,e),t.include(d.O,e),t.include(l.w,e);const a=e.normalType===d.r.Attribute||e.normalType===d.r.Compressed;a&&e.offsetBackfaces&&t.include(n.w),t.include(_.Q,e),t.include(p.Bb,e),e.instancedColor&&t.attributes.add(V.T.INSTANCECOLOR,"vec4"),W.add("vPositionLocal","vec3"),t.include(m.D,e),t.include(o.qj,e),t.include(h.R,e),t.include(f.c,e),r.uniforms.add(new L.N("externalColor",(e=>e.externalColor))),W.add("vcolorExt","vec4"),e.hasMultipassTerrain&&W.add("depth","float"),e.hasModelTransformation&&r.uniforms.add(new F.g("model",(e=>null!=e.modelTransformation?e.modelTransformation:i.I))),r.code.add(H.H`
      void main(void) {
        ...
        if (vcolorExt.a < ${H.H.float(O.b)}) {
          ...
          ${a?H.H`vNormalWorld = dpNormal(vvLocalNormal(normalModel()));`:""}
    ...
    `)}switch(e.output){case a.H.Alpha:t.include(s.f5,e),t.include(M.z,e),t.include(A.l,e),G.uniforms.add(new D.p("opacity",(e=>e.opacity)),new D.p("layerOpacity",(e=>e.layerOpacity))),e.hasColorTexture&&G.uniforms.add(new U.A("tex",(e=>e.texture))),G.include(P.y),G.code.add(H.H`
      void main() {
        discardBySlice(vpos);
    ...
    `);break;case a.H.Color:t.include(s.f5,e),t.include(x.XP,e),t.include(T.K,e),t.include(M.z,e),t.include(e.instancedDoublePrecision?R.hb:R.XE,e),t.include(A.l,e),(0,I.hY)(G,e),G.uniforms.add(r.uniforms.get("localOrigin"),new N.J("ambient",(e=>e.ambient)),new N.J("diffuse",(e=>e.diffuse)),new D.p("opacity",(e=>e.opacity)),new D.p("layerOpacity",(e=>e.layerOpacity))),e.hasColorTexture&&G.uniforms.add(new U.A("tex",(e=>e.texture))),t.include(w.jV,e),t.include(S.T,e),G.include(P.y),t.include(E.k,e),(0,x.PN)(G),(0,x.sC)(G),(0,b.F1)(G),G.code.add(H.H`
      void main() {
        discardBySlice(vpos);
        ${e.hasMultipassTerrain?"terrainDepthTest(gl_FragCoord, depth);":""}
        ${e.hasColorTexture?H.H`
        ...
        ${e.normalType===d.r.ScreenDerivative?H.H`
        ...
        ${e.transparencyPassType===z.A.Color?H.H`fragColor = premultiplyAlpha(fragColor);`:""}
      }
    `)}return t.include(v.s,e),t}const W=Object.freeze(Object.defineProperty({__proto__:null,build:G},Symbol.toStringTag,{value:"Module"}))},41846:(e,t,r)=>{r.d(t,{R:()=>F,b:()=>H});var i=r(1391),o=r(62707),n=r(55039),a=r(51546),s=r(77171),l=r(47624),c=r(60624),d=r(37099),u=r(76056),h=r(135),m=r(11317),f=r(92555),p=r(89136),g=r(95134),v=r(89753),_=r(5802),T=r(42001),x=r(26322),b=r(85504),A=r(22539),E=r(92302),S=r(96310),w=r(85787),R=r(90692),C=r(62062),y=r(172),O=r(71250),M=r(21437),P=r(74709),I=r(33680),N=r(98069),L=r(93144),D=r(35065);function H(e){const t=new I.kG,{vertex:r,fragment:H,varyings:F}=t;return(0,C.Sv)(r,e),t.include(d.f),F.add("vpos","vec3"),t.include(E.k,e),t.include(l.f,e),t.include(f.L,e),e.output!==n.H.Color&&e.output!==n.H.Alpha||((0,C.hY)(t.vertex,e),t.include(c.O,e),t.include(s.w,e),e.offsetBackfaces&&t.include(o.w),e.instancedColor&&t.attributes.add(D.T.INSTANCECOLOR,"vec4"),F.add("vNormalWorld","vec3"),F.add("localvpos","vec3"),e.hasMultipassTerrain&&F.add("depth","float"),t.include(h.D,e),t.include(i.qj,e),t.include(u.R,e),t.include(m.c,e),r.uniforms.add(new O.N("externalColor",(e=>e.externalColor))),F.add("vcolorExt","vec4"),r.code.add(P.H`
        void main(void) {
          forwardNormalizedVertexColor();
          vcolorExt = externalColor;
          ${e.instancedColor?"vcolorExt *= instanceColor * 0.003921568627451;":""}
    ...
    `)),e.output===n.H.Color&&(t.include(a.f5,e),t.include(v.XP,e),t.include(g.K,e),t.include(w.z,e),t.include(e.instancedDoublePrecision?A.hb:A.XE,e),t.include(T.l,e),(0,C.hY)(t.fragment,e),(0,_.Pe)(H),(0,v.PN)(H),(0,v.sC)(H),H.uniforms.add(r.uniforms.get("localOrigin"),r.uniforms.get("view"),new y.J("ambient",(e=>e.ambient)),new y.J("diffuse",(e=>e.diffuse)),new M.p("opacity",(e=>e.opacity)),new M.p("layerOpacity",(e=>e.layerOpacity))),e.hasColorTexture&&H.uniforms.add(new N.A("tex",(e=>e.texture))),t.include(b.jV,e),t.include(x.T,e),H.include(R.y),(0,_.F1)(H),H.code.add(P.H`
      void main() {
        discardBySlice(vpos);
        ${e.hasMultipassTerrain?P.H`terrainDepthTest(gl_FragCoord, depth);`:""}
        ${e.hasColorTexture?P.H`
    ...
    `)),t.include(p.s,e),t}const F=Object.freeze(Object.defineProperty({__proto__:null,build:H},Symbol.toStringTag,{value:"Module"}))},25377:(e,t,r)=>{r.d(t,{S:()=>v,b:()=>f,g:()=>p});var i=r(4307),o=r(97323),n=r(51666),a=r(5543),s=r(20787),l=r(19693),c=r(21437),d=r(74709),u=r(33680),h=r(98069);const m=16;function f(){const e=new u.kG,t=e.fragment;return e.include(n.k),t.include(a.S),e.include(s.G),t.uniforms.add(new c.p("radius",((e,t)=>p(t.camera)))),t.code.add(d.H`vec3 sphere[16];
void fillSphere() {
...
return fallOffFunction(vv, vn, 0.1);
}`),t.uniforms.add(new l.A("nearFar",((e,t)=>t.camera.nearFar)),new h.A("normalMap",(e=>e.normalTexture)),new h.A("depthMap",(e=>e.depthTexture)),new l.A("zScale",((e,t)=>(0,s.R)(t))),new c.p("projScale",(e=>e.projScale)),new h.A("rnm",(e=>e.noiseTexture)),new l.A("rnmScale",((e,t)=>(0,i.s)(g,t.camera.fullWidth/e.noiseTexture.descriptor.width,t.camera.fullHeight/e.noiseTexture.descriptor.height))),new c.p("intensity",(e=>e.intensity)),new l.A("screenSize",((e,t)=>(0,i.s)(g,t.camera.fullWidth,t.camera.fullHeight)))),t.code.add(d.H`
    void main(void) {
      fillSphere();
  ...
  `),e}function p(e){return Math.max(10,20*e.computeRenderPixelSizeAtDist(Math.abs(4*e.relativeElevation)))}const g=(0,o.a)(),v=Object.freeze(Object.defineProperty({__proto__:null,build:f,getRadius:p},Symbol.toStringTag,{value:"Module"}))},59915:(e,t,r)=>{r.d(t,{S:()=>p,b:()=>f});var i=r(17896),o=r(51666),n=r(5543),a=r(98925),s=r(19693),l=r(21437),c=r(74709),d=r(33680),u=r(16374),h=r(98069);const m=4;function f(){const e=new d.kG,t=e.fragment;e.include(o.k);const r=(m+1)/2,f=1/(2*r*r);return t.include(n.S),t.uniforms.add(new h.A("depthMap",(e=>e.depthTexture)),new u.R("tex",(e=>e.colorTexture)),new a.q("blurSize",(e=>e.blurSize)),new l.p("projScale",((e,t)=>{const r=(0,i.i)(t.camera.eye,t.camera.center);return r>5e4?Math.max(0,e.projScale-(r-5e4)):e.projScale})),new s.A("nearFar",((e,t)=>t.camera.nearFar))),t.code.add(c.H`
...
return mix(color, vec4(HIGHLIGHT_COLOR.rgb, color.a), highlightFactor * HIGHLIGHT_COLOR.a);
      ...
      `:l.H`#define highlightSlice(_color_, _pos_) (_color_)`;t.hasSliceInVertexProgram&&e.vertex.code.add(i),e.fragment.code.add(i),e.fragment.code.add(n)}(e,t,new s.B("slicePlaneOrigin",((e,r)=>function(e,t,r){if(null==r.slicePlane)return a.Z;const i=d(e,t,r),o=u(i,r.slicePlane),s=h(e,i,r);return null!=s?(0,n.m)(p,o,s):o}(t,e,r))),new s.B("slicePlaneBasis1",((e,r)=>m(t,e,r,r.slicePlane?.basis1))),new s.B("slicePlaneBasis2",((e,r)=>m(t,e,r,r.slicePlane?.basis2))))}function d(e,t,r){return e.instancedDoublePrecision?(0,n.s)(f,r.camera.viewInverseTransposeMatrix[3],r.camera.viewInverseTransposeMatrix[7],r.camera.viewInverseTransposeMatrix[11]):t.slicePlaneLocalOrigin}function u(e,t){return null!=e?(0,n.b)(p,t.origin,e):t.origin}function h(e,t,r){return e.hasSliceTranslatedView?null!=t?(0,i.w)(v,r.camera.viewMatrix,t):r.camera.viewMatrix:null}function m(e,t,r,i){if(null==i||null==r.slicePlane)return a.Z;const o=d(e,t,r),s=u(o,r.slicePlane),l=h(e,o,r);return null!=l?((0,n.a)(g,i,s),(0,n.m)(p,s,l),(0,n.m)(g,g,l),(0,n.b)(g,g,p)):i}const f=(0,a.c)(),p=(0,a.c)(),g=(0,a.c)(),v=(0,o.c)()},77171:(e,t,r)=>{r.d(t,{w:()=>n});var i=r(1391),o=r(74709);function n(e,t){if((0,i.bA)(e),t.hasModelTransformation)return e.vertex.code.add(o.H`vec4 transformPositionWithDepth(mat4 proj, mat4 view, mat4 model, vec3 pos, vec2 nearFar, out float depth) {
...
return proj * (view * vec4(pos, 1.0));
}`)}},47624:(e,t,r)=>{r.d(t,{f:()=>p});var i=r(43697),o=r(17896),n=r(65617),a=r(55039),s=r(89243),l=r(62062),c=r(70582),d=r(74709),u=r(51354),h=r(35065),m=r(9820);class f extends u.m{constructor(){super(...arguments),this.instancedDoublePrecision=!1}}function p(e,t){t.instanced&&t.instancedDoublePrecision&&(e.attributes.add(h.T.MODELORIGINHI,"vec3"),e.attributes.add(h.T.MODELORIGINLO,"vec3"),e.attributes.add(h.T.MODEL,"mat3"),e.attributes.add(h.T.MODELNORMAL,"mat3"));const r=e.vertex;t.instancedDoublePrecision&&(r.include(s.$,t),r.uniforms.add(new c.B("viewOriginHi",((e,t)=>(0,m.U8)((0,o.s)(g,t.camera.viewInverseTransposeMatrix[3],t.camera.viewInverseTransposeMatrix[7],t.camera.viewInverseTransposeMatrix[11]),g))),new c.B("viewOriginLo",((e,t)=>(0,m.GB)((0,o.s)(g,t.camera.viewInverseTransposeMatrix[3],t.camera.viewInverseTransposeMatrix[7],t.camera.viewInverseTransposeMatrix[11]),g))))),r.code.add(d.H`
    vec3 calculateVPos() {
    ...
    `)}(0,i._)([(0,u.o)()],f.prototype,"instancedDoublePrecision",void 0);const g=(0,n.c)()},60624:(e,t,r)=>{r.d(t,{O:()=>l,r:()=>i});var i,o,n=r(74085),a=r(74709),s=r(35065);function l(e,t){switch(t.normalType){case i.Compressed:e.attributes.add(s.T.NORMALCOMPRESSED,"vec2"),e.vertex.code.add(a.H`vec3 normalModel() {
...
void forwardNormalizedVertexColor() {}`)}},15719:(e,t,r)=>{r.d(t,{Bb:()=>d,d4:()=>u});var i=r(74085),o=r(46521),n=(r(88669),r(60624)),a=r(2095),s=r(74709),l=r(52114),c=r(19850);function d(e,t){switch(t.normalType){case n.r.Attribute:case n.r.Compressed:e.include(n.O,t),e.varyings.add("vNormalWorld","vec3"),e.varyings.add("vNormalView","vec3"),e.vertex.uniforms.add(new l.j("transformNormalGlobalFromModel",(e=>e.transformNormalGlobalFromModel)),new c.c("transformNormalViewFromGlobal",(e=>e.transformNormalViewFromGlobal))),e.vertex.code.add(s.H`void forwardNormal() {
...
return transformWorldFromViewTL + vPositionWorldCameraRelative;
}`)}class p extends d.K{constructor(){super(...arguments),this.transformWorldFromViewTH=(0,n.c)(),this.transformWorldFromViewTL=(0,n.c)(),this.transformViewFromCameraRelativeRS=(0,i.c)(),this.transformProjFromView=(0,o.c)()}}},91982:(e,t,r)=>{r.d(t,{i:()=>s});var i=r(74085),o=r(135),n=r(74709);function a(e){e.fragment.code.add(n.H`vec4 textureAtlasLookup(sampler2D tex, vec2 textureCoordinates, vec4 atlasRegion) {
...
return applyScreenSizePerspectiveScaleFactorVec2(size, screenSizePerspectiveScaleFactor(absCosAngle, distanceToCamera, params));
    ...
    `)):r.code.add(a.H`vec3 addVerticalOffset(vec3 worldPos, vec3 localOrigin) { return worldPos; }`)}const u=(0,o.c)()},89136:(e,t,r)=>{r.d(t,{s:()=>R});var i=r(13598),o=r(1391),n=r(55039),a=r(51546),s=r(77171),l=r(60624),c=r(74709),d=r(35065);function u(e,t){const r=t.output===n.H.ObjectAndLayerIdColor,i=t.objectAndLayerIdColorInstanced;r&&(e.varyings.add("objectAndLayerIdColorVarying","vec4"),i?e.attributes.add(d.T.INSTANCEOBJECTANDLAYERIDCOLOR,"vec4"):e.attributes.add(d.T.OBJECTANDLAYERIDCOLOR,"vec4")),e.vertex.code.add(c.H`
     void forwardObjectAndLayerIdColor() {
      ${r?i?c.H`objectAndLayerIdColorVarying = instanceObjectAndLayerIdColor * 0.003921568627451;`:c.H`objectAndLayerIdColorVarying = objectAndLayerIdColor * 0.003921568627451;`:c.H``} }`),e.fragment.code.add(c.H`
      void outputObjectAndLayerIdColor() {
        ${r?c.H`fragColor = objectAndLayerIdColorVarying;`:c.H``} }`)}var h=r(135),m=r(15719),f=r(20285);function p(e,t){switch(e.fragment.include(f.n),t.output){case n.H.Shadow:case n.H.ShadowHighlight:case n.H.ShadowExcludeHighlight:e.fragment.code.add(c.H`float _calculateFragDepth(const in float depth) {
...
}`)}}var g=r(88669),v=r(98069);const _=(0,g.f)(1,1,0,1),T=(0,g.f)(1,0,1,1);function x(e){e.fragment.uniforms.add(new v.A("depthTex",((e,t)=>t.highlightDepthTexture))),e.fragment.constants.add("occludedHighlightFlag","vec4",_).add("unoccludedHighlightFlag","vec4",T),e.fragment.code.add(c.H`void outputHighlight() {
...
fragColor = unoccludedHighlightFlag;
...
}`)}var b=r(92302),A=r(85787),E=r(62062),S=r(8319),w=r(47026);function R(e,t){const{vertex:r,fragment:d}=e,f=t.hasModelTransformation;f&&r.uniforms.add(new S.g("model",(e=>null!=e.modelTransformation?e.modelTransformation:i.I)));const g=t.hasColorTexture&&t.alphaDiscardMode!==w.JJ.Opaque;switch(t.output){case n.H.Depth:case n.H.Shadow:case n.H.ShadowHighlight:case n.H.ShadowExcludeHighlight:case n.H.ObjectAndLayerIdColor:(0,E.Sv)(r,t),e.include(s.w,t),e.include(h.D,t),e.include(b.k,t),e.include(p,t),e.include(a.f5,t),e.include(u,t),(0,o.Zu)(e),e.varyings.add("depth","float"),g&&d.uniforms.add(new v.A("tex",(e=>e.texture))),r.code.add(c.H`
          void main(void) {
            vpos = calculateVPos();
            vpos = subtractOrigin(vpos);
            vpos = addVerticalOffset(vpos, localOrigin);
        ...
        `),e.include(A.z,t),d.code.add(c.H`
          void main(void) {
            discardBySlice(vpos);
            ${g?c.H`
                    vec4 texColor = texture(tex, ${t.hasColorTextureTransform?c.H`colorUV`:c.H`vuv0`});
                    discardOrAdjustAlpha(texColor);`:""}
            ${t.output===n.H.ObjectAndLayerIdColor?c.H`outputObjectAndLayerIdColor();`:c.H`outputDepth(depth);`}
          }
        `);break;case n.H.Normal:{(0,E.Sv)(r,t),e.include(s.w,t),e.include(l.O,t),e.include(m.Bb,t),e.include(h.D,t),e.include(b.k,t),g&&d.uniforms.add(new v.A("tex",(e=>e.texture))),t.normalType===l.r.ScreenDerivative&&e.varyings.add("vPositionView","vec3");const i=t.normalType===l.r.Attribute||t.normalType===l.r.Compressed;r.code.add(c.H`
          void main(void) {
            vpos = calculateVPos();

            ${i?c.H`
                  vNormalWorld = dpNormalView(vvLocalNormal(normalModel()));`:c.H`
                  // Get vertex position in camera space for screen-space derivative normals
                  vPositionView = (view * (${f?"model *":""} vec4(vpos, 1.0))).xyz;
                `}
            vpos = subtractOrigin(vpos);
            vpos = addVerticalOffset(vpos, localOrigin);
        ...
        `),e.include(a.f5,t),e.include(A.z,t),d.code.add(c.H`
          void main() {
            discardBySlice(vpos);
            ${g?c.H`
                    vec4 texColor = texture(tex, ${t.hasColorTextureTransform?c.H`colorUV`:c.H`vuv0`});
            ...
            ${t.normalType===l.r.ScreenDerivative?c.H`vec3 normal = screenDerivativeNormal(vPositionView);`:c.H`
        ...
        `);break}case n.H.Highlight:(0,E.Sv)(r,t),e.include(s.w,t),e.include(h.D,t),e.include(b.k,t),g&&d.uniforms.add(new v.A("tex",(e=>e.texture))),r.code.add(c.H`
          void main(void) {
            vpos = calculateVPos();
            vpos = subtractOrigin(vpos);
            vpos = addVerticalOffset(vpos, localOrigin);
        ...
        `),e.include(a.f5,t),e.include(A.z,t),e.include(x,t),d.code.add(c.H`
          void main() {
            discardBySlice(vpos);
            ${g?c.H`
                    vec4 texColor = texture(tex, ${t.hasColorTextureTransform?c.H`colorUV`:c.H`vuv0`});
...
}`)}},15817:(e,t,r)=>{r.d(t,{Q:()=>u});var i=r(135),o=r(91982),n=r(19419),a=r(74709),s=r(16374),l=r(98069),c=r(67498),d=r(35065);function u(e,t){const r=e.fragment;t.hasVertexTangents?(e.attributes.add(d.T.TANGENT,"vec4"),e.varyings.add("vTangent","vec4"),t.doubleSidedMode===n.q.WindingOrder?r.code.add(a.H`mat3 computeTangentSpace(vec3 normal) {
...
float evaluateAmbientOcclusion() { return 0.0; }`)}},89753:(e,t,r)=>{r.d(t,{XP:()=>R,PN:()=>S,sC:()=>w});var i=r(74085),o=r(17896),n=r(65617),a=r(98766),s=r(88669),l=r(85504),c=r(172),d=r(71250),u=r(74709);function h(e,t){const r=e.fragment,i=void 0!==t.lightingSphericalHarmonicsOrder?t.lightingSphericalHarmonicsOrder:2;0===i?(r.uniforms.add(new c.J("lightingAmbientSH0",((e,t)=>(0,o.s)(m,t.lighting.sh.r[0],t.lighting.sh.g[0],t.lighting.sh.b[0])))),r.code.add(u.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):1===i?(r.uniforms.add(new d.N("lightingAmbientSH_R",((e,t)=>(0,a.s)(f,t.lighting.sh.r[0],t.lighting.sh.r[1],t.lighting.sh.r[2],t.lighting.sh.r[3]))),new d.N("lightingAmbientSH_G",((e,t)=>(0,a.s)(f,t.lighting.sh.g[0],t.lighting.sh.g[1],t.lighting.sh.g[2],t.lighting.sh.g[3]))),new d.N("lightingAmbientSH_B",((e,t)=>(0,a.s)(f,t.lighting.sh.b[0],t.lighting.sh.b[1],t.lighting.sh.b[2],t.lighting.sh.b[3])))),r.code.add(u.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):2===i&&(r.uniforms.add(new c.J("lightingAmbientSH0",((e,t)=>(0,o.s)(m,t.lighting.sh.r[0],t.lighting.sh.g[0],t.lighting.sh.b[0]))),new d.N("lightingAmbientSH_R1",((e,t)=>(0,a.s)(f,t.lighting.sh.r[1],t.lighting.sh.r[2],t.lighting.sh.r[3],t.lighting.sh.r[4]))),new d.N("lightingAmbientSH_G1",((e,t)=>(0,a.s)(f,t.lighting.sh.g[1],t.lighting.sh.g[2],t.lighting.sh.g[3],t.lighting.sh.g[4]))),new d.N("lightingAmbientSH_B1",((e,t)=>(0,a.s)(f,t.lighting.sh.b[1],t.lighting.sh.b[2],t.lighting.sh.b[3],t.lighting.sh.b[4]))),new d.N("lightingAmbientSH_R2",((e,t)=>(0,a.s)(f,t.lighting.sh.r[5],t.lighting.sh.r[6],t.lighting.sh.r[7],t.lighting.sh.r[8]))),new d.N("lightingAmbientSH_G2",((e,t)=>(0,a.s)(f,t.lighting.sh.g[5],t.lighting.sh.g[6],t.lighting.sh.g[7],t.lighting.sh.g[8]))),new d.N("lightingAmbientSH_B2",((e,t)=>(0,a.s)(f,t.lighting.sh.b[5],t.lighting.sh.b[6],t.lighting.sh.b[7],t.lighting.sh.b[8])))),r.code.add(u.H`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
}`))}const m=(0,n.c)(),f=(0,s.c)();var p=r(95134),g=r(5802),v=r(26322),_=r(27754),T=r(79884),x=r(67498);class b extends T.x{constructor(e,t){super(e,"bool",x.P.Pass,((r,i,o)=>r.setUniform1b(e,t(i,o))))}}var A=r(21437);r(22021),(0,n.c)();const E=.4;function S(e){e.constants.add("ambientBoostFactor","float",E)}function w(e){e.uniforms.add(new A.p("lightingGlobalFactor",((e,t)=>t.lighting.globalFactor)))}function R(e,t){const r=e.fragment;switch(e.include(p.K,t),t.pbrMode!==l.f7.Disabled&&e.include(v.T,t),e.include(h,t),e.include(_.e),r.code.add(u.H`
    const float GAMMA_SRGB = 2.1;
    const float INV_GAMMA_SRGB = 0.4761904;
    ${t.pbrMode===l.f7.Disabled?"":"const vec3 GROUND_REFLECTANCE = vec3(0.2);"}
  `),S(r),w(r),(0,g.Pe)(r),r.code.add(u.H`
...
}`),t.pbrMode){case l.f7.Disabled:case l.f7.WaterOnIntegratedMesh:case l.f7.Water:e.include(g.kR),r.code.add(u.H`vec3 evaluateSceneLighting(vec3 normalWorld, vec3 albedo, float shadow, float ssao, vec3 additionalLight)
{
...
inputs.averageAmbientRadiance = ambientLightIrradianceComponent[1] * (1.0 + GROUND_REFLECTANCE[1]);`),r.code.add(u.H`
    ...
    `);break;case l.f7.Terrain:case l.f7.TerrainWithWater:e.include(g.kR),r.code.add(u.H`const float roughnessTerrain = 0.5;
...
return outColor;
}`))}},85504:(e,t,r)=>{r.d(t,{f7:()=>i,jV:()=>m});var i,o,n=r(72119),a=r(91982),s=r(70582),l=r(172),c=r(74709),d=r(16374),u=r(98069),h=r(67498);function m(e,t){const r=e.fragment,o=t.hasMetallicRoughnessTexture||t.hasEmissionTexture||t.hasOcclusionTexture;if(t.pbrMode===i.Normal&&o&&e.include(a.i,t),t.pbrMode!==i.Schematic)if(t.pbrMode!==i.Disabled){if(t.pbrMode===i.Normal){r.code.add(c.H`vec3 mrr;
vec3 emission;
float occlusion;`);const e=t.pbrTextureBindType;t.hasMetallicRoughnessTexture&&(r.uniforms.add(e===h.P.Pass?new u.A("texMetallicRoughness",(e=>e.textureMetallicRoughness)):new d.R("texMetallicRoughness",(e=>e.textureMetallicRoughness))),r.code.add(c.H`void applyMetallnessAndRoughness(vec2 uv) {
vec3 metallicRoughness = textureLookup(texMetallicRoughness, uv).rgb;
mrr[0] *= metallicRoughness.b;
mrr[1] *= metallicRoughness.g;
}`)),t.hasEmissionTexture&&(r.uniforms.add(e===h.P.Pass?new u.A("texEmission",(e=>e.textureEmissive)):new d.R("texEmission",(e=>e.textureEmissive))),r.code.add(c.H`void applyEmission(vec2 uv) {
emission *= textureLookup(texEmission, uv).rgb;
}`)),t.hasOcclusionTexture?(r.uniforms.add(e===h.P.Pass?new u.A("texOcclusion",(e=>e.textureOcclusion)):new d.R("texOcclusion",(e=>e.textureOcclusion))),r.code.add(c.H`void applyOcclusion(vec2 uv) {
occlusion *= textureLookup(texOcclusion, uv).r;
}
float getBakedOcclusion() {
return occlusion;
}`)):r.code.add(c.H`float getBakedOcclusion() { return 1.0; }`),e===h.P.Pass?r.uniforms.add(new l.J("emissionFactor",(e=>e.emissiveFactor)),new l.J("mrrFactors",(e=>e.mrrFactors))):r.uniforms.add(new s.B("emissionFactor",(e=>e.emissiveFactor)),new s.B("mrrFactors",(e=>e.mrrFactors))),r.code.add(c.H`
    void applyPBRFactors() {
      mrr = mrrFactors;
      emission = emissionFactor;
      occlusion = 1.0;

      ${t.hasMetallicRoughnessTexture?c.H`applyMetallnessAndRoughness(${t.hasMetallicRoughnessTextureTransform?c.H`metallicRoughnessUV`:"vuv0"});`:""}

      ${t.hasEmissionTexture?c.H`applyEmission(${t.hasEmissiveTextureTransform?c.H`emissiveUV`:"vuv0"});`:""}

      ${t.hasOcclusionTexture?c.H`applyOcclusion(${t.hasOcclusionTextureTransform?c.H`occlusionUV`:"vuv0"});`:""}
    }
...
const float HALF_PI = 1.570796326794897;`)}},22539:(e,t,r)=>{r.d(t,{XE:()=>m,hb:()=>h}),r(65617);var i=r(20285),o=r(71250),n=r(15736),a=r(74709),s=r(79884),l=r(67498);class c extends s.x{constructor(e,t,r){super(e,"mat4",l.P.Draw,((r,i,o)=>r.setUniformMatrix4fv(e,t(i,o))),r)}}class d extends s.x{constructor(e,t,r){super(e,"mat4",l.P.Pass,((r,i,o)=>r.setUniformMatrix4fv(e,t(i,o))),r)}}var u=r(98069);function h(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new d("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),f(e))}function m(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new c("shadowMapMatrix",((e,t)=>t.shadowMap.getShadowMapMatrices(e.origin)),4)),f(e))}function f(e){const t=e.fragment;t.include(i.n),t.uniforms.add(new u.A("shadowMapTex",((e,t)=>t.shadowMap.depthTexture)),new n._("numCascades",((e,t)=>t.shadowMap.numCascades)),new o.N("cascadeDistances",((e,t)=>t.shadowMap.cascadeDistances))),t.code.add(a.H`int chooseCascade(float depth, out mat4 mat) {
...
}`)}},57806:(e,t,r)=>{r.d(t,{DT:()=>d,NI:()=>s,R5:()=>l,av:()=>a,jF:()=>c});var i=r(14682),o=r(74709),n=r(19850);function a(e){e.vertex.uniforms.add(new n.c("colorTextureTransformMatrix",(e=>null!=e.colorTextureTransformMatrix?e.colorTextureTransformMatrix:(0,i.c)()))),e.varyings.add("colorUV","vec2"),e.vertex.code.add(o.H`void forwardColorUV(){
...
}`)}const u=(0,a.c)();function h(e){return 0===e.camera.projectionMatrix[11]?(0,i.s)(m,0,1):(0,i.s)(m,1,0)}const m=(0,o.a)()},89243:(e,t,r)=>{r.d(t,{$:()=>o});var i=r(74709);function o({code:e},t){t.doublePrecisionRequiresObfuscation?e.add(i.H`vec3 dpPlusFrc(vec3 a, vec3 b) {
